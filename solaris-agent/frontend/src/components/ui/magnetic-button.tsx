...
export function MagneticButton({ children, className, onClick, ...props }: MagneticButtonProps) {
    ...
    const handleMouseMove = (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        mouseX.set(distanceX * 0.3); // Magnetic strength 0.3
    ...
    return (
        <>
            <motion.button
                ...
                {...props}
            >
                {/* Animated border via padding trick */}
                <div className="absolute inset-0 z-0 p-[1px] rounded-md overflow-hidden bg-white/20">
                    ...
                    {/* Inner background to mask the conic gradient to just the border */}
