...
export function Pipeline() {
    ...
    const handleStartScan = async () => {
        ...
        try {
            ...
            const response = await triggerScan(repoUrl.trim());
    ...
    return (
        <div className="w-full relative z-10 px-6 py-8 max-w-[1400px] mx-auto min-h-screen">
            ...
            <motion.div
                ...
                className="mb-8"
            >
                <h1 className="text-[2rem] font-[800] tracking-[-0.03em] text-white mb-1">Security Pipeline</h1>
                <p className="font-mono text-[0.7rem] text-[rgba(232,234,240,0.4)]">Scan a GitHub repository for vulnerabilities and code quality issues</p>
            </motion.div>
                                ...
                                {loadingHistory ? (
                                    ...
                                    <div className="space-y-2 max-h-80 overflow-y-auto">
                                        {scanHistory.map((scan) => (
                                            ...
                                            >
                                                <div className="flex items-center gap-3">
                                                    <div className={`w-2 h-2 rounded-full ${scan.status === 'completed' ? 'bg-emerald-500' :
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <span className={`text-xs px-2 py-1 rounded ${scan.status === 'completed' ? 'bg-emerald-500/10 text-emerald-400' :
            ...
            >
                <Card className="border-white/[0.06] bg-black/50 backdrop-blur-2xl overflow-hidden">
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2 mb-1">
                                                    ...
                                                    <div className={`w-2 h-2 rounded-full ${stage.team === 'red' ? 'bg-[#ff3b3b]' : 'bg-[#2dffb3]'}`} />
                                                </div>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <button
                                            ...
                                            className={`px-3 py-1.5 text-sm rounded-lg transition-colors ${reportView === 'summary'
                                        ...
                                        <button
                                            ...
                                            className={`px-3 py-1.5 text-sm rounded-lg transition-colors ${reportView === 'detailed'
                                                ? 'bg-emerald-600 text-white'
                                                : 'bg-gray-800 text-gray-400 hover:bg-gray-700'
                                                }`}
                                        >
                                                                    ...
                                                                    <div className="p-4 space-y-4">
                                                                        ...
                                                                        <div className="flex items-center gap-4 text-xs">
                                                                            <span className="text-gray-500">
                                                                                Confidence: <span className={`font-medium ${finding.confidence === 'high' ? 'text-emerald-400' :
