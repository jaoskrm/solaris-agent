...
// Lazy-load all pages including Landing for consistent Suspense behavior
...
// Map pathnames to nav tab names
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans overflow-hidden relative selection:bg-emerald-500/30">
      {/* Background Video — hidden on swarm view */}
      {!isSwarm && (
        <div className="fixed inset-0 z-0 overflow-hidden" style={{ aspectRatio: '16/9' }}>
          ...
          {/* Video element - loads from public folder or CDN */}
          <video
            autoPlay
            muted
            loop
            ...
            onError={(e) => {
              // Video failed to load - CSS fallback is already showing
          ...
          {/* Subtle glow — GPU-only opacity animation */}
      ...
      {/* Main Content Area — wrapped in ErrorBoundary + Suspense for lazy pages */}
      <ErrorBoundary>
