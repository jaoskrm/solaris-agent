#!/usr/bin/env python3
"""
PoC: Authentication Bypass - http://localhost:3000/admin/users
Generated from VibeCheck Red Team mission

VULNERABILITY DETAILS:
The HTTP response status code is 200 OK, indicating successful authentication.
"""

import requests

TARGET = "http://localhost:3000/admin/users"
